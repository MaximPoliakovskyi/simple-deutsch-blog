...
$lines | Set-Content -Path 'C:\simple-deutsch-blog\web\src\proxy.ts' -Encoding UTF8
Remove-Item -Path 'C:\simple-deutsch-blog\web\src\middleware.ts' -Force -ErrorAction SilentlyContinue
Write-Host "Written proxy.ts: $(Test-Path 'C:\simple-deutsch-blog\web\src\proxy.ts')"
Write-Host "middleware.ts gone: $((-not (Test-Path 'C:\simple-deutsch-blog\web\src\middleware.ts')))"
