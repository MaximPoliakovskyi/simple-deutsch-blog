...
const en: Translations = {
  ...
  heroDescription: "Interactive lessons, real-world exercises, and clear progress tracking — learn German at your pace.",
...
const ua: Translations = {
  ...
  heroDescription: "Інтерактивні уроки, вправи з реальних ситуацій і зручне відстеження прогресу — вивчайте німецьку у власному темпі.",
...
const ru: Translations = {
  ...
  heroDescription: "Интерактивные уроки, упражнения из реальных ситуаций и удобный трекер прогресса — учите немецкий в своем темпе.",
