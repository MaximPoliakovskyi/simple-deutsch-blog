	...
	return (
		<main className="mx-auto max-w-7xl px-6 py-12">
			<div className="mx-auto max-w-3xl prose dark:prose-invert">
				...
				<p className="text-sm text-muted-foreground">{(t["privacy.lastUpdated"] || "").replace("{date}", "2025-12-25")}</p>
				...
				<p>
					{t["privacy.s13.p"]}{" "}
					<a className="text-blue-600 dark:text-blue-400" href="mailto:hello@simpledeutsch.com">hello@simpledeutsch.com</a>
				</p>
			</div>
		</main>
	);
