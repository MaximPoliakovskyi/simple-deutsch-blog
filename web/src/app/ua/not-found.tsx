  ...
  return (
    <div className="fixed inset-0 z-[100] grid place-items-center bg-black text-white">
      <div className="text-center px-4">
        ...
        <div className="mt-6">
          <Link href="/ua" className="inline-flex items-center rounded-md bg-[#1d9bf0] px-4 py-2 text-sm font-medium text-white hover:brightness-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1d9bf0]/70">
            {t.backToHome}
          </Link>
        </div>
      </div>
