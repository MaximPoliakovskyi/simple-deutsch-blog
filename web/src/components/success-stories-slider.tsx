...
export default function SuccessStoriesSlider({
  ...
  const enabledBtn =
    "border-neutral-300 text-neutral-700 hover:bg-neutral-200/60 dark:border-neutral-600 dark:text-neutral-200 dark:hover:bg-neutral-700/40 cursor-pointer";
  const disabledBtn =
    "border-neutral-200 text-neutral-400 dark:border-neutral-700 dark:text-neutral-600 cursor-not-allowed";
